          ...
          <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
              ...
              <input type="text" id="first_name"
                ...
                placeholder="Enter first name" required v-model="form.first_name" />
            </div>
            <div>
              ...
              <input type="text" id="last_name"
                ...
                placeholder="Enter last name" required v-model="form.last_name" />
            </div>
          </div>
          <div class="mb-6">
            ...
            <input type="email" id="email"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none"
              placeholder="name@email.com" required v-model="form.email" />
          </div>
          <div class="mb-6">
            ...
            <input type="text" id="phone"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none"
              placeholder="Enter your phone" required v-model="form.phone" />
          </div>
          <div class="mb-6">
            <label for="subject" class="block mb-2 text-sm font-medium text-gray-900">Subject</label>
            <input type="Subject" id="subject"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none"
              placeholder="Enter subject" required v-model="form.subject" />
          </div>
          <div class="mb-6">
            <label for="message" class="block mb-2 text-sm font-medium text-gray-900">Message</label>
            <textarea id="message" rows="5"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:outline-none"
              required placeholder="Enter your message" v-model="form.message"></textarea>
          </div>
          <button type="submit"
            class="text-white bg-blue-ff border-2 hover:border-blue-ff hover:bg-transparent hover:text-black font-medium rounded-lg text-sm w-full sm:w-auto px-8 py-2.5 text-center transition-all">Send</button>
        </form>
      </div>
    </div>
  </div>
